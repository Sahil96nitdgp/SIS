...
//include '../login_val.php';
	include 'update_personal_input.php';
...
<body>
	<form action="update_personal.php" name="form" method="POST">
	<div id="main">
		<center><font size=10 color="black"><b>UPDATE PERSONAL DETAILS</b></font></center>
	</div>
	...
	<div id="upper">
		...
		<table>
			...
			<tr>
				...
				<td>
					<input type="text" name="fname" value=<?php echo '"'.$_SESSION['fname'].'"';  ?> id="name1" size="30" onblur="validateName1('name1')" required /><span id="a"></span>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="mname" value=<?php echo '"'.$_SESSION['mname'],'"';  ?>  size="30" onblur="validateName2('name2')" /><span id="b"></span>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="lname" value=<?php echo '"'.$_SESSION['lname'].'"';  ?> id="name3" size="30" onblur="validateName3('name3')" required /><span id="c"></span>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="gname" value=<?php echo '"'.$_SESSION['gname'].'"';  ?> id="name4" size="30" onblur="validateName4('name4')" required /><span id="d"></span>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="date" name="dob" value=<?php echo '"'.$_SESSION['dob'].'"';  ?> id="txtDate" onblur="submitBday();" onsubmit="valdob()" size="30" required /><span id="erdob"></span>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<span id="age" name="age"><?php echo $_SESSION['age']; ?></span>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="email" name="email" value=<?php echo '"'.$_SESSION['email'].'"';  ?> id="email" Placeholder="email" onblur="validateEmail('email')" /><span id="error" ></span>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<option value=<?php echo '"'.$_SESSION['bg'].'"';  ?> selected><?php echo $_SESSION['bg'];  ?></option>
					<option>A+</option>
					<option >B+</option>
					<option >AB+</option>
					<option >O+</option>
			...
			<tr>
				...
				<td>
					<font size="4" color="black"><input type="radio" name="gender" value="male" size="10" checked required>Male</font>
			...
			<tr>
				...
				<td>
					...
					<font size="4" color="black"><input type="radio" name="caste" id="cast" value="OBC" checked required>OBC</font>
			...
			<tr>
				...
				<td>
					<textarea rows="5" cols="60"  name="cadd" id="area1"  placeholder="enter address" required><?php echo $_SESSION['cadd']; ?></textarea>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type="number" value=<?php echo '"'.$_SESSION['cpin'].'"';  ?> name="cpin" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="required" required>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type="text" name="cstate" value=<?php echo '"'.$_SESSION['cstate'].'"';  ?> class="required" required>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="ccoun" value=<?php echo '"'.$_SESSION['ccoun'].'"'; ?> class="required" required>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<textarea rows="5" cols="60"  name="padd" id="area2"  placeholder="enter address" required><?php echo $_SESSION['padd']; ?></textarea>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type="number" value=<?php echo '"'.$_SESSION['ppin'].'"'; ?> name="ppin" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="required" required>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type="text" value=<?php echo '"'.$_SESSION['pstate'].'"'; ?> name="pstate" class="required" required>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type="text" name="pcoun" value=<?php echo '"'.$_SESSION['pcoun'].'"'; ?> class="required" required>
				</td>
			</tr>
		...
		<table>
			<tr>
				...
				<td>
					<font size="4" color="#cc0000" face="Tahoma">
						...
						<input type="checkbox" name="hobby2" value="Singing" checked="" >Singing <br> 
						<input type="checkbox" name="hobby3" value="Dancing" checked="">Dancing <br> 
					</font>
					<br>
					<textarea id='txt' rows="4" cols="30"  name="hobby4" placeholder="Please specify your hobby if you select 'others'"><?php echo $_SESSION['hobbyextra']; ?></textarea><br><br>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<br><textarea id="txt" rows="5" cols="50" name="eac" ><?php echo '"'.$_SESSION['eac'].'"'; ?></textarea>
				</td>
			</tr>
		...
		<center>
			<div id="upper2">
				<input type="submit" value="UPDATE" name="update_personal_submit" />
			</div>
		</center>
		</br></br>
	</form>
