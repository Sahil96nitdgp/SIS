<?php include 'header2.php';
		...
		include 'update_educational_input.php'; 
...
<html>
	...
	<body>
		<form action="update_educational.php" name="form1" method="POST">
			<div id="main">
				<center><font size=10 color="black"><b>Update EDUCATIONAL DETAILS</b></font></center>
			</div>
				...
				<center>
					<table >
						...
						<tr>
							...
							<td>
								<input type="text" value=<?php echo '"'.$_SESSION['college_name'].'"'; ?>  name="college_name" id="college" size="30" onblur="validate('college');" required /><span id="clg"></span>
							</td>
						</tr>

						<tr>
							<td><font size="5" color="#cc0000" face="Tahoma" >Programme: </font></td>
							<td><select name="programme" id="prog" value=<?php echo $_SESSION['programme']; ?> />
								<option selected><?php echo $_SESSION['programme']; ?></option>
						...
						<tr>
							...
							<td>
								<input type="text" name="regno" value=<?php echo '"'.$_SESSION['reg_no'].'"'; ?> id="reg" Placeholder="registration no." maxlength='8' onchange='createYear()' onblur='validateReg()' onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="required" required /><span id="regis"></span>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<select name="dept" value=<?php echo $_SESSION['dept']; ?> onchange="changedept()" id="select" class="required" required />

								<option style="font-family:courier"><?php echo $_SESSION['dept']; ?></option>
						...
						<tr>
							...
							<td>
								...
								<input type="number" value=<?php echo '"'.$_SESSION['roll'].'"'; ?> style="width:40px" name="roll" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="required" required />
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<select name="sem" value=<?php echo $_SESSION['sem']; ?> id="sem" required />
								<option value="-1" selected><?php echo $_SESSION['sem']; ?></option>
						...
						<tr>
							...
							<td><input type=number value=<?php echo '"'.$_SESSION['college_cgpa'].'"'; ?> name="college_cgpa" id="cgpa" size="30" required /></td>
						</tr>
						...
						<tr>
							...
							<td>
								<input type=number value=<?php echo '"'.$_SESSION['college_year'].'"'; ?> name="college_year" id="collegeyear" size="30" required />
							</td>		    
						</tr>
					...
					<table border="1">
                        ...
                        <tr>
                            ...
                            <td>
                            	<input name="tename" value=<?php echo '"'.$_SESSION['tename'].'"'; ?> type="text1" id="th1" Placeholder="enter" onblur="validate1('th1');" required /><span id="a"></span></td>
                            </td>
                            <td>
                            	<input name="teboard" value=<?php echo '"'.$_SESSION['teboard'].'"'; ?> type="text1" id="th2" Placeholder="enter" onblur="validate2('th2');" required /><span id="b"></span>
                            </td>

                            <td>
                            	<input type=number value=<?php echo '"'.$_SESSION['teyear'].'"'; ?> name="teyear" id="teyear" size="30" required />
							</td>
							<td>
								<input name="tecgpa" value=<?php echo '"'.$_SESSION['tecgpa'].'"'; ?> type="number" id="th" Placeholder="enter" step=".01" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required />
							</td>
						</tr>
						<tr>
							<td><font size="4" color="#cc0000" face="Tahoma">12TH</font></td>
							<td>
								<input name="twelve_name" value=<?php echo '"'.$_SESSION['twelve_name'].'"'; ?> type="text1" id="th3" Placeholder="enter" onblur="validate3('th3');" required /><span id="c"></span>
							</td>
							<td>
								<input name="twelve_board" value=<?php echo '"'.$_SESSION['twelve_board'].'"'; ?> type="text1" id="th4" Placeholder="enter" onblur="validate4('th4');" required /><span id="d"></span>
							</td>
							<td>
								<input type=number value=<?php echo '"'.$_SESSION['twelve_year'].'"'; ?> name="twelve_year" id="twelve_year" size="30" required />
							</td>
							<td>
								<input name="twelve_cgpa" value=<?php echo '"'.$_SESSION['twelve_cgpa'].'"'; ?> type="number" id="th" Placeholder="enter" step=".01" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required />
							</td>
						</tr>
		...
		<center>
			<div id="upper2">
				<a href="update_educational.php"><input type="reset"></a>
				<input type="submit" value="UPDDATE" name="update_educational_submit" />
			</div>
		</center>
		</br></br>
